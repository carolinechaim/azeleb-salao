			...
			<div class="portofoliothumb">
				<div class="portofoliothumboverlay fouroverlay">
					...
					<div class="inner fourdetail">
						<a class="projectdetail" href="reserva">OSASCO</a>
					</div>
				</div>
				<img src="https://i.ibb.co/Wt50qWX/fundo-contato-salao-em-osas.jpg" class="fourimage" alt=""/>
			</div>
		</div>
		...
		<div class="three columns category castles">
			...
			<div class="portofoliothumb">
				<div class="portofoliothumboverlay fouroverlay">
					...
					<div class="inner fourdetail">
						<a class="projectdetail" href="reserva">VILA MARIANA</a>
					</div>
				</div>
				<img src="https://i.ibb.co/5RzjjvJ/p-foto-000215560.jpg" class="fourimage" alt=""/>
			</div>
		</div>
		...
		<div class="three columns category nature">
			...
			<div class="portofoliothumb">
				<div class="portofoliothumboverlay fouroverlay">
					...
					<div class="inner fourdetail">
						<a class="projectdetail" href="reserva">   MOEMA</a>
					</div>
				</div>
				<img src="https://i.ibb.co/gTTZ6r9/unnamed.jpg" class="fourimage" alt=""/>
			</div>
		</div>
		...
		<div class="three columns category castles">
			...
			<div class="portofoliothumb">
				<div class="portofoliothumboverlay fouroverlay">
					...
					<div class="inner fourdetail">
						<a class="projectdetail" href="reserva">BROOKLING NOVO</a>
					</div>
				</div>
				<img src="https://i.ibb.co/sCX5sJW/p-foto-000361135.jpg" class="fourimage" alt=""/>
			</div>
		</div>
	</div>
</div>
