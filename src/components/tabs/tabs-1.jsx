...
const Tabs1 = () => {
	...
	<div style={{margin:100}}class="six columns">
		...
		<ul class="tabs-content">
			...
			{activeButton=='simple1'&&(<Tabela />)}
			{activeButton=='simple2'&&(<h1>Tabela de agendamentos manicure</h1>)}
			{activeButton=='simple3'&&(<h1>Tabela de agendamentos pedicure</h1>)}
			{activeButton=='simple4'&&(<h1>Tabela de agendamentos Depilação</h1>)}
			{activeButton=='simple5'&&(<h1>Tabela de agendamentos Sombrancelha</h1>)}
